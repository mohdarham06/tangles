...
export const OutlineHeart = () => {
    return (
        <svg className="" aria-label="Like" height="24" width="24" viewBox="0 0 24 24">
            <title>Like</title>
...
export const FillHeart = () => {
    return (
        <svg className="" aria-label="Unlike" height="24" width="24" viewBox="0 0 48 48">
            <title>Unlike</title>
...
export const OutlineComment = () => {
    return (
        <svg className="" aria-label="Comment" height="24" width="24" role="img" viewBox="0 0 24 24">
            <title>Comment</title>
...
export const OutlineShare = () => {
    return (
        <svg className="" aria-label="Share Post" height="24" width="24" role="img" viewBox="0 0 24 24">
